...
Tags: site, content, ratings, ICRA, label
...
1. Upload the folder 'icra-label-generator' to the `/wp-content/plugins/` directory
1. Activate the plugin through the 'Plugins' menu in WordPress
1. Visit the ICRA Label Generator settings page to configure plugin.
...
= Backend Features =
* add support for legacy PICS system

== License ==

* ICRA Label Generator plugin is released under the GNU GPL version 3.0 or later.
